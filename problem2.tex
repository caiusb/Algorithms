...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
	  \Function{SortPancakes}{$P[1..n]$}
		...
		\State \Call{FlipPancakes}{$P[1..n]$,$p$} \Comment{$O(\frac{n}{2})$} \label{line:pancake:flip-large}
		\State \Call{FlipPancakes}{$P[1..n]$,$0$} \Comment{$O(\frac{n}{2})$} \label{line:pancake:flip-all}
